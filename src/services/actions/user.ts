...
export const logInRequest = (form: IInputData) => {
...
export const updateUserData = (accessToken: string | undefined, name: string | undefined, email: string | undefined, password: string | undefined) => {
  return function(dispatch: AppDispatch) {
    dispatch({
